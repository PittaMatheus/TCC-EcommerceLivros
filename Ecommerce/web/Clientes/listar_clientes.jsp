			...
			return;
                ...
                %>
                     <%
                         ...
                         if(clientes.size() == 0) {%>
                            ...
                            <div class="navbar-fixed indigo darken-4">
                                <nav>
                                    <div class="nav-wrapper indigo darken-4">
                                      <a href="#" class="brand-logo center maiusculo">Nenhum cliente cadastrado</a>
                                      <ul class="left">
                            ...
                            <br> <br> <br>
                            <div class="container center"><img src="https://img.icons8.com/clouds/400/000000/guest-male.png"></div>
                    <%
                         } else {
                     %>
                <!-- NAV FIXO DO TOPO-->
                <div class="navbar-fixed indigo darken-4">
                   <form action='DesativarCliente'>
                    <nav>
                        <div class="nav-wrapper indigo darken-4">
                          <a href="#" class="brand-logo center maiusculo">Dados dos clientes</a>
                          <ul id="nav-mobile" class="right hide-on-med-and-down">
                              <li><button type="submit" class="btn-border" name="acao" value="desativar"><i class="material-icons left">done</i>Desativar Cliente</button></li>
                          </ul>
                          <ul class="left">
                              <li><a href="../Clientes/home.jsp"><i class="material-icons">arrow_back</i></a></li>
                          </ul>
                ...
                <div class ="container2">
                            ...
                            <table border="1" class="bordered highlight centered responsive-table">
                                <thead>
                            ...
                            for (Cliente cliente : clientes) {
                                out.println("<tr>");
                                out.println("<td><input type='radio' required name='id' value=" + cliente.getId() + " id=" + cliente.getId() + " /><label for='"+ cliente.getId() +"'></label></td>");
