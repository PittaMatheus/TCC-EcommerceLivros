                         ...
                         if(livros.size() == 0) {%>
                            ...
                            <div class="navbar-fixed indigo darken-4">
                                <nav>
                                    <div class="nav-wrapper indigo darken-4">
                                      <a href="#" class="brand-logo center maiusculo">Nenhum livro Cadastro</a>
                                      <ul class="left">
                            ...
                            <%}else {%> 
                                ...
                                <div class="navbar-fixed indigo darken-4">
                                    ...
                                    <nav>
                                        <div class="nav-wrapper indigo darken-4">
                                          <a href="#" class="brand-logo center maiusculo">Livros ativos</a>
                                          <ul id="nav-mobile" class="right">      
                                              <li><button type="submit" name="acao" value="desativar" class="btn-border"><i class='material-icons left'>done</i>Desativar livro</button></li>
                                          </ul>
                                          <ul class="left">
                                              <li><a href="../Clientes/home.jsp"><i class="material-icons">arrow_back</i></a></li>
                                          </ul>
                                ...
                                <div class ="container2 row">
                                    ...
                                    <%
                                     ...
                                     <tr class="text-pequeno">
                                        ...
                                        <td><a class='btn orange' href="preAlterar_livro.jsp?id=<% out.print(livro.getId()); %>"><i class='material-icons'>edit</i></a></td>
                                        </tr>
                                    <% }} %>
                                    </table>
                                   </form>
