 ...
 * @author bocao
 */
public class TesteLivrariaClienteCompra {
    ...
    @Test
    public void testELivrariaCliente() throws Exception {
      ...
      driver.findElement(By.linkText("Add1")).click();
      driver.findElement(By.partialLinkText("Adicionar ao carrinho")).click();
      driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='MatheusS'])[1]/preceding::i[1]")).click();
