 ...
 * @author bocao
 */
public class TesteLivrariaAnaliseCustoVendaLucroMes {
    ...
    @Test
    public void testLivrariaAnalise() throws Exception {
        ...
        driver.findElement(By.partialLinkText("Análise de custo, receita e lucro por mês")).click();
